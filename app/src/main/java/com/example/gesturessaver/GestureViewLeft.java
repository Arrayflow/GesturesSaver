...
public class GestureViewLeft extends View {
    private ListenTouchEvent listenTouchEvent;
    public TouchUpEventLeft touchUpEvent;
    ...
    public GestureViewLeft(Context context) {
        super(context);
        init(context);
    }

    public GestureViewLeft(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public GestureViewLeft(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        }
    ...
    public void setTouchUpEvent(TouchUpEventLeft event) {
